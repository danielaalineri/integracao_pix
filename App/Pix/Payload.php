...
/**
 * Metodo Responsável por retornar os valors completos dos campos aidiocnais do pix
 * @return string
 */
private function  getAdditionalDataFieldTemplate(){
//TXID
$txid = $this->getValue(self::ID_ADDITIONAL_DATA_FIELD_TEMPLATE_TXID, $this->txid);
return $this->getAdditionalDataFieldTemplate(self::ID_ADDITIONAL_DATA_FIELD_TEMPLATE, $txid); 
}
